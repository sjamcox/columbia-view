...
const REGISTRATION_URL =
  'https://columbiaview.churchcenter.com/registrations/events/3621035'

export default function AvivaKidsHero() {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <video
        ...
        muted
        playsInline
        poster="/videos/hero-aviva-kids-poster.jpg"
        className="h-auto min-h-[calc(60vh+100px)] w-full object-cover md:min-h-[70vh]"
        style={{ aspectRatio: '16/9' }}
      >
        <source src="/videos/hero-aviva-kids.webm" type="video/webm" />
        <source src="/videos/hero-aviva-kids.mp4" type="video/mp4" />
        ...
        <div className="container mx-auto px-4 pb-24 md:pb-28 lg:pb-32">
          <div className="max-w-3xl">
            <h1 className="font-display mb-4 text-5xl font-black tracking-tight text-white drop-shadow-xl md:text-7xl lg:text-8xl">
              <span className="font-light">You&rsquo;re invited to</span> <br />
              Aviva Kids
            </h1>
            <p className="mb-2 text-xl font-semibold text-white drop-shadow-lg md:text-2xl lg:text-3xl">
              A free kids festival &amp; BBQ
            </p>
            <p className="mb-8 text-lg font-medium text-white/90 drop-shadow-lg md:text-xl">
              Saturday, August 8, 2026 &middot; Free BBQ at noon
            </p>
            <div className="flex flex-wrap gap-4">
              <Button href={REGISTRATION_URL} color="blue">
